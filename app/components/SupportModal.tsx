          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Scan QR code or click button</p>
                </div>
              </div>
              <button
            ...
            {showPaypalQR && (
              <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg text-center">
                    ...
                    if (parent) {
                      parent.innerHTML = `
                        <div class="text-center">
                          ...
                          <p class="text-xs text-gray-500 mt-2">Click the button below to donate</p>
                          <a
                            href="https://www.paypal.com/ncp/payment/BVLBTSB46W6VQ"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="inline-block mt-2 px-4 py-2 bg-[#0070ba] text-white text-sm rounded-lg hover:bg-[#003087] transition-colors"
                          >
                            Donate via PayPal
                          </a>
                        </div>
                ...
                />
                <p className="text-xs text-gray-500 mt-2">Scan with PayPal app or click button below</p>
                <a
                  href="https://www.paypal.com/ncp/payment/BVLBTSB46W6VQ"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block mt-2 px-4 py-2 bg-[#0070ba] text-white text-sm rounded-lg hover:bg-[#003087] transition-colors w-full text-center"
                >
                  💙 Donate via PayPal
                </a>
              </div>
