    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-2 pt-4">
          ...
          <div className="mt-4 text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-gray-100 transition-colors text-sm w-full justify-center"
            >
        ...
        <div className="px-4 pb-4">
          <button onClick={onNewChat} className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-700 dark:text-gray-300 font-medium">
                ...
                <div key={conv.id} className={`group relative rounded-lg transition-colors ${currentConversationId === conv.id ? 'bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
                  {editingId === conv.id ? (
                    ...
                    <div onClick={() => onLoadConversation(conv.id)} className="flex items-center justify-between px-3 py-2 cursor-pointer">
                      ...
                      <button onClick={(e) => handleMenuToggle(conv.id, e)} className="flex-shrink-0 p-1.5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-gray-100 dark:hover:bg-gray-700">
