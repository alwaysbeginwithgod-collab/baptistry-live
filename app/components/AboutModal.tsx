      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto z-10">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  Just as a <strong>baptistry</strong> (the pool where baptism is performed) is a place of public declaration of faith and obedience, <strong>BAPTISTRY</strong> (the tool) is a place where believers can grow in their knowledge of God's Word.
                </p>
          ...
          <div className="text-center space-y-2 py-2">
            <p className="text-gray-800 dark:text-gray-200 text-base">📧 <a href="mailto:always.begin.with.god@gmail.com?subject=BAPTISTRY%20Feedback" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">always.begin.with.god@gmail.com</a></p>
            <p className="text-gray-800 dark:text-gray-200 text-base">🏛️ <a href="https://www.bordergatebaptist.net" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">bordergatebaptist.net</a></p>
          </div>
